...
class ResNet50_GRU_engine:
      ...
      def train_and_evaluate(self, train_loader, val_loader, epochs, save_path=None):
            train_losses = []
            val_losses = []
            train_accuracies = []
            val_accuracies = []
            ...
            for epoch in range(epochs):
                  ...
                  print(f"Epoch {epoch+1}/{epochs}, Train Loss: {train_loss}, Train Acc: {train_accuracy}, Val Loss: {val_loss}, Val Acc: {val_accuracy}")
      ...
      def train_and_evaluate(self, train_loader, val_loader, epochs, 
            ...
            for epoch in range(epochs):
                  ...
                  for batch in train_loader:
                        ...
                        loss_driver = self.riterion_driver(driver_out, fmap_labels.long())
